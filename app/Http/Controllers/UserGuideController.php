...
class UserGuideController extends Controller
{
    ...
    public function show(Request $request,  $id): JsonResponse
    {
        ...
        return response()->json(UserGuideResource::collection($data));
    }

    public function update(CreateUserGuideRequest $request, $id): JsonResponse
    {
    ...
    public function getSchema(): JsonResponse
    {
        return response()->json([
            \Illuminate\Support\Facades\DB::select("DESCRIBE user_guides")
        ]);
    }
}
