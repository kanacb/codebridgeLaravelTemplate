...
class UserGuideStepController extends Controller
{
    ...
    public function index(Request $request): JsonResponse 
    {
        ...
        if ($request->has('userGuideID')) {$query->where('userGuideID', $request->input('userGuideID'));}
if ($request->has('steps')) {$query->where('steps', $request->input('steps'));}
if ($request->has('description')) {$query->where('description', $request->input('description'));}
    ...
    public function store(CreateUserGuideStepRequest $request): JsonResponse 
    {
        ...
        //     ]);
        // }
        $data = UserGuideStep::create($request->validated());
    ...
    public function getSchema() : JsonResponse{
        return response()->json([
            \Illuminate\Support\Facades\DB::select("DESCRIBE userGuideSteps")
        ]);
    }
