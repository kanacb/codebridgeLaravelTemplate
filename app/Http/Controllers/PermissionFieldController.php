...
class PermissionFieldController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json(["data" => PermissionFieldResource::collection($results)]);
    }
    ...
    public function store(CreatePermissionFieldRequest $request): JsonResponse
    {
        ...
        $data = PermissionField::create($request->all());
    ...
    public function show(Request $request,  $id): JsonResponse
    {
        ...
        return response()->json(PermissionFieldResource::collection($data));
    }
    ...
    public function getSchema(): JsonResponse
    {
        return response()->json([
            \Illuminate\Support\Facades\DB::select("DESCRIBE permission_fields")
        ]);
    }
}
