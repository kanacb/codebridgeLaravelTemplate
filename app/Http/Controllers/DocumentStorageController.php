...
class DocumentStorageController extends Controller
{
    ...
    public function update(Request $request, $id): JsonResponse
    {
        ...
        return response()->json(['message' => 'DocumentStorage updated successfully', 'data' => $data, "id" => $id, 'newData' => $newData]);
    }
    ...
    public function getSchema(): JsonResponse
    {
        return response()->json([
            \Illuminate\Support\Facades\DB::select("DESCRIBE documentStorage")
        ]);
    }
}
