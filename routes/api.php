...
Route::middleware('auth:sanctum', 'active_user')->group(function () {
    ...
    Route::resource("documentStorage", DocumentStorageController::class);
    Route::get("documentStorageSchema", [DocumentStorageController::class, "getSchema"]);
